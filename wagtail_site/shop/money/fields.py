...
from wagtail_site.shop.money.iso4217 import CURRENCIES
from wagtail_site.shop.money.money_maker import MoneyMaker, AbstractMoney
...
class MoneyFieldWidget(forms.widgets.NumberInput):
    ...
    def __init__(self, attrs=None):
        defaults = {'style': 'width: 150px; text-align: right'}
        try:
...
class MoneyField(models.DecimalField):
    ...
    def get_prep_value(self, value):
        ...
        return super(models.DecimalField, self).to_python(value)
